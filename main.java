...
public class main 
{
    public static void main(String[] args) 
    {
        ...
        CARRENTAL car1 = new CARRENTAL("KDP388F", "Toyota Voxy");
        CARRENTAL car2 = new CARRENTAL("KDG246Y", "Filder Corola");
        agency.addCar(car1);
        agency.addCar(car2);

            Customer customer1 = new Customer("Brian", "3468221");
        Customer customer2 = new Customer("Erick ", "8970659");
        agency.addCustomer(customer1);
        agency.addCustomer(customer2);
        
        try {
            System.out.println("Renting car KDP388F to Brian ");
            agency.rentCarToCustomer("KDP388F", "3468221");
            System.out.println("Car KDP388F is now unavailable.");
        } catch (Exception e) {
        ...
        try 
        {
            System.out.println("Returning car KDP388F from Brian ");
